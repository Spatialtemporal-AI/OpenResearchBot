---
name: openpi-runner
description: "自动化安装 Physical Intelligence 的 OpenPI 项目。涵盖环境搭建、uv 管理、补丁修复及 Baseline 自动跑通。"
metadata: {"nanobot":{"emoji":"🐈","requires":{"bins":["git","uv","nvidia-smi"]}}}
---
